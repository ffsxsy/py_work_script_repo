...
flowchart TD
    ...
    CHECK --> DISPATCH["rbmsParseRecvDataFun()<br/>0x04:0x01"]
...
| 分发入口 | `rbmsParseRecvDataFun()` | `cmdGroup==0x04 && cmdId==0x01` |
...
除 `0x04:0x01` 位图外，`RBMS_SumInfo（0x03:0x01）` 含摘要字段，**不能替代**逐条故障位图：
